...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'premium'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/premium/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_premium', format_string($course->fullname));
