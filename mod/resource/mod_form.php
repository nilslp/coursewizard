...
class mod_resource_mod_form extends moodleform_mod {
    function definition() {
        ...
        // @COREHACK - checkbox to support Hero Images in app - DPMH 2013/03/20
        if (file_exists($CFG->dirroot.'/mod/spacedpractice')) {
            $mform->addElement('checkbox', 'iscoursehero', get_string('iscoursehero', 'spacedpractice'));
            $mform->addHelpButton('iscoursehero', 'iscoursehero', 'spacedpractice');
            $mform->setDefault('iscoursehero', 0);
            $mform->setAdvanced('iscoursehero', true);
        }
        // END COREHACK
