...
class scorm_basic_report extends scorm_default_report {
    ...
    function display($scorm, $cm, $course, $download) {
        ...
        // @COREHACK - setting name initials for persistent firstname/lastname ordering
        $tifirst = optional_param('tifirst', '', PARAM_ALPHA);
        $tilast = optional_param('tilast', '', PARAM_ALPHA);
        $PAGE->set_url(new moodle_url($PAGE->url, array('attemptsmode' => $attemptsmode, 'tifirst'=>$tifirst, 'tilast'=>$tilast)));
        // END COREHACK
