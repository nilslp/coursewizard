 ...
 * @param mixed $fs either a filestorage instance or null @COREHACK
 * @return bool false if file not found, does not return if found - just send the file
 */
function scorm_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array(), $fs=null) {
    global $CFG;
    ...
    // @COREHACK Removed below for scorm speedup (about 50% less load time) DMPH 2013-04-10
    ...
    // @COREHACK - can pass filestorage object as param for minor speedup DPMH 2013-04-10
    if (empty($fs)) {
        $fs = get_file_storage();
    }
