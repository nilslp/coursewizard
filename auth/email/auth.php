...
class auth_plugin_email extends auth_plugin_base {
    ...
    function user_signup($user, $notify=true) {
        ...
        // @COREHACK - DMPH 2013-03-01 - added call to custom email confirmation that allows addition of CC field
        $welcomeemaillib = $CFG->dirroot.'/local/welcome_email/lib.php';
        if (file_exists($welcomeemaillib)) {
            require_once($welcomeemaillib);
            if (!local_welcome_email_send_confirmation_email($user)) {
