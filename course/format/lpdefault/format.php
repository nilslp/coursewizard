...
// KC - Removing in 2.5 - functions no longer exist
...
$strshowalltopics = get_string('showalltopics', 'format_lpdefault');
...
if ($editing) {
    $strtopichide = get_string('hidetopicfromothers', 'format_lpdefault');
    $strtopicshow = get_string('showtopicfromothers', 'format_lpdefault');
...
if ($thissection->summary or $thissection->sequence or $PAGE->user_is_editing()) {
    ...
    if ($PAGE->user_is_editing()) {
        ...
        echo $courserenderer->course_section_add_cm_control($course, $section, null, array('inblock' => false));
    }
...
if($courseformatoptions['numsections'] < $defaultcount) $courseformatoptions['numsections']==$defaultcount;
foreach($lpdefaultsections as $lpsection){
    ...
    if ($showsection) {
        ...
        if ($displaysection == $section) {    // Show the zoom boxes
            ...
            $strshowonlytopic = get_string("showonlytopic", "format_lpdefault", $section);
        ...
        if ($PAGE->user_is_editing() && has_capability('moodle/course:update', context_course::instance($course->id))) {
            ...
            if ($section < $courseformatoptions['numsections']) {    // Add a arrow to move section down
...
while ($section <= $courseformatoptions['numsections']) {
