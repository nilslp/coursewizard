...
// @COREHACK - Bug #5849 Force users to login to do course searches if set
if ($CFG->forcelogin || get_config('local/lp_courseaccessmanager','forceloginforcoursesearch')) { 
    require_login();
}
// END COREHACK
