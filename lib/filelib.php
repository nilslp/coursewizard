...
function file_pluginfile($relativepath, $forcedownload, $preview = null) {
    ...
    // ========================================================================================================================
    // @COREHACK - moved this switch to top - slight optimization DPMH 2013-04-10
    if (strpos($component, 'mod_') === 0) {
        ...
        if (function_exists($filefunction)) {
            ...
            // @COREHACK - pass filestorage object for minor optimization DMPH 2013-04-10
            if ($component === 'mod_scorm') {
                $filefunction($course, $cm, $context, $filearea, $args, $forcedownload, array('preview' => $preview), $fs);
            } else {
