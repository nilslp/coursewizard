...
$PAGE->set_heading(get_string('completedpurchaseorders', 'block_shopping_basket'));
...
$orders = get_completed_purchase_orders();
...
echo html_writer::link(new moodle_url('/blocks/shopping_basket/purchase_orders.php'), get_string('pendingpurchaseorders', 'block_shopping_basket'), array('class' => 'inactive_section', 'title' => get_string('pendingpurchaseorders', 'block_shopping_basket')));
echo html_writer::link(new moodle_url('/blocks/shopping_basket/purchase_orders_completed.php'), get_string('completedpurchaseorders', 'block_shopping_basket'), array('class' => 'active_section', 'title' => get_string('completedpurchaseorders', 'block_shopping_basket')));
