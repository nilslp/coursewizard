...
require_once($CFG->dirroot.'/blocks/lp_reportbuilder/filters/simple_hierarchy_select.php');
        ...
        if(isset($filter->filtertype)) {
            ...
            case 'selectin': 
                ...
                if(method_exists($this->_report->src, $selectfunc)) {
                    $options = isset($filter->selectoptions) ? $filter->selectoptions : null;
                }
            case 'multicheck':
                $selectfunc = 'rb_filter_'.$filter->selectfunc;
